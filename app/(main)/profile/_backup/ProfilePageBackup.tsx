...
export const profileBackupMetadata: Metadata = {
  title: "프로필 백업 - RyuWoong",
  description: "기존 프로필 페이지 백업본입니다.",
};

export default function ProfilePageBackup() {
  return (
      ...
      <section className={styles.section} id="experience">
        ...
        <FadeInSection className={styles.row}>
          ...
          <div className={styles["row-right"]}>
            ...
            <div className={styles.project}>
              ...
              <p className="typo-body">- 배포 속도: 평균 2~3초 → 1~2초 단축 </p>
            </div>
            <div className={styles.project}>
              <h4 className="typo-h3">Codepush에서 HotUpdater로 전환</h4>
              <p className="typo-body">- 앱 배포 안정성 개선</p>
              <p className="typo-body">- 라이브러리 유지보수성 개선</p>
              <p className="typo-body">- 서버 운영비용 절감 (AWS ECS에서 AWS S3와 Lambda로 변경)</p>
            </div>
            <div className={styles.project}>
              <h4 className="typo-h3">App CI/CD</h4>
              <p className="typo-body">
        ...
        <FadeInSection className={styles.row}>
          ...
          <div className={styles["row-right"]}>
            ...
            <div className={styles.project}>
              <h4 className="typo-h3">앱 사이즈 최적화</h4>
              <p className="typo-body">- 기존 70~80MB → 50MB 이하로 경량화</p>
              <p className="typo-body">- CodePush BundleSize 30~40MB → 10MB로 축소</p>
              <p className="typo-body">- CodePush 배포 속도: 평균 4~5초에서 2~3초로 단축</p>
              <p className="typo-body">- CodePush 롤백 수 약 50% 감소, 운영 안정성 증가</p>
            </div>
            <div className={styles.project}>
            ...
            <div className={styles.project}>
              <h4 className="typo-h3">컴포넌트 제작 및 라이브러리 최적화</h4>
              <p className="typo-body">- 과도한 UI 라이브러리 제거 및 경량화</p>
              <p className="typo-body">- 디자인 시스템 기반 자체 컴포넌트 개발로 유지보수성 강화</p>
              <p className="typo-body">- React Native 버전 업그레이드 및 New Architecture 대응</p>
              <p className="typo-body"> • 지원 미흡/기능 제한 라이브러리 대체 및 구현</p>
            </div>

            <div className={styles.project}>
              <h4 className="typo-h3">Data Layer 개선</h4>
              <p className="typo-body">- React Query를 활용하여 불필요한 API 호출을 제거</p>
              <p className="typo-body">- 데이터 캐싱 전략을 개선해 네트워크 효율성과 앱 성능을 향상</p>
              <p className="typo-body">- 에러 핸들링 로직을 강화하여 안정성과 사용자 경험을 함께 개선</p>
            </div>
          </div>
        </FadeInSection>
        ...
        <FadeInSection className={styles.row}>
          ...
          <div className={styles["row-right"]}>
            ...
            <div className={styles.project}>
              <h4 className="typo-h3">프로젝트 참여</h4>
              <p className="typo-body">
                - React Native를 활용한 오픈마켓, 예약 시스템, 결제 시스템 등 4~5개 프로젝트 참여
              </p>
            </div>
            <div className={styles.project}>
              <h4 className="typo-h3">WebApp BoilerPlate 제작</h4>
              <p className="typo-body">- React Native 기반 WebApp 개발 템플릿 제작</p>
              <p className="typo-body">- 신속한 프로젝트 셋업 가능하도록 내부 공유</p>
            </div>
            <div className={styles.project}>
              <h4 className="typo-h3">Project 관리 Notion Template 제작</h4>
              <p className="typo-body">- 업무 효율 개선을 위한 Notion 도입 제안 및 템플릿 제작 후 내부 공유</p>
            </div>
            <div className={styles.project}>
